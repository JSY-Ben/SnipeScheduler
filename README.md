...
- The 'snipeit_user_group_cache_update.php'. script is used to regularly update what Snipe-IT Groups your users are in, and to grab cached copies of user's Snipe-IT user avatars for use in this app. Doing live API checks for this info slows down the app on large installations. It is recommended you run this new cron script regularly enough to keep user and user group information up-to-date.  This is mainly used for the 'Permissions' feature, to restrict what checkout users can see and what equipment is available to users in specific Snipe-IT User Groups. The use of this script requires that you enter your Snipe-IT Group IDs on the 'Permissions' tab of the 'Settings' section of SnipeScheduler. This is to avoid having to require an API User with Super-Admin Access on Snipe-IT. There are instructions on the 'Permissions' tab for how to obtain your Snipe-IT Group IDs. 

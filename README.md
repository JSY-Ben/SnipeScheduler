...
- The 'snipeit_user_group_cache_update.php'. script is used to regularly update what Snipe-IT Groups your users are in. Doing live API checks for this info slows down the app too much on large installations. It is recommended you run this new cron script as regularly as possible to keep user group information up-to-date. This is mainly used for the 'Permissions' feature to restrict what checkout users can see and what equipment is available to users in specific Snipe-IT User Groups.

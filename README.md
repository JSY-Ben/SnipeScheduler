...
- This app has been tested with version 8 of Snipe-IT up to Version **v8.6.1**
...
<img width="1998" height="2240" alt="Catalogue" src="https://github.com/user-attachments/assets/95b59217-e50c-426e-b3d7-9e56bd6c3720" />

<img width="1998" height="2881" alt="Reservations" src="https://github.com/user-attachments/assets/c7106b92-d18b-476d-b582-52c84c51d21a" />
...
- The 'snipeit_user_group_cache_update.php'. script is used to regularly update what Snipe-IT Groups your users are in. Doing live API checks for this info slows down the app on large installations. It is recommended you run this new cron script regularly enough to keep user group information up-to-date.  This is mainly used for the 'Permissions' feature, to restrict what checkout users can see and what equipment is available to users in specific Snipe-IT User Groups. The use of this feature currently requires your Snipe-IT API User to have Super-Admin privileges to access group information on Snipe-IT. I realise this is not ideal, but unfortunately Snipe-IT does not currently have the ability to give non Super-Admin users access to details about User Groups without checking each user individually for group membership details, which would take a very long time on large installations. Please use with caution.

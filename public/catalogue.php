...
function extract_asset_default_location_name(array $asset): string
{
    $candidates = [
...
if ($isAuthenticated) {
    ...
    if ($favouritesAvailable && $favouritesUserEmail !== '') {
...
$catalogueReturnQuery = array_filter(
    $catalogueReturnQuery,
